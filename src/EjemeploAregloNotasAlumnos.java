...
public class EjemeploAregloNotasAlumnos {
    public static void main(String[] args) {
        ...
        System.out.println("Promedio clase historia: " + promedioMatematica);
        System.out.println("Promedio clase lenguaje: " + promedioMatematica);
